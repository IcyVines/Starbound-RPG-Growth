...
function updateStats()
  ...
  self.statBonuses = {
    strength = 1 + ( status.stat("ivrpgstrengthscaling") * 1.25),
    agility = 1 + ( status.stat("ivrpgagilityscaling") * 1.25),
    vitality = 1 + ( status.stat("ivrpgvitalityscaling") * 1.25),
    vigor = 1 + ( status.stat("ivrpgvigorscaling") * 1.25),
    intelligence = 1 + ( status.stat("ivrpgintelligencescaling") * 1.25),
    endurance = 1 + ( status.stat("ivrpgendurancescaling") * 1.25),
    dexterity = 1 + ( status.stat("ivrpgdexterityscaling") * 1.25)
  }
  else  
  self.statBonuses = {
