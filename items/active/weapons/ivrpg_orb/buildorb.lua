...
function build(directory, config, parameters, level, seed)
  ...
  replacePatternInData(config, nil, "<altElementalType>", elementalType)
  ...
  replacePatternInData(config, nil, "<boltMod>", boltMod[elementalType] or "")
  replacePatternInData(config, nil, "<burstMod>", burstMod[elementalType] or "")

  replacePatternInData(config, nil, "<moteMod>", moteMod[elementalType] or "")
  replacePatternInData(config, nil, "<waveMod>", waveMod[elementalType] or "")
  replacePatternInData(config, nil, "<stormMod>", stormMod[elementalType] or "")
  replacePatternInData(config, nil, "<bladeMod>", bladeMod[elementalType] or "")
  -- name
