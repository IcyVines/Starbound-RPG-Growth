Moonlightblade = WeaponAbility:new()

function Moonlightblade:init()
  self.cooldownTimer = self.cooldownTime

  self.active = false
end

function Moonlightblade:update(dt, fireMode, shiftHeld)
...
function Moonlightblade:empower()
...
function Moonlightblade:windup()
...
function Moonlightblade:uninit()

end

function Moonlightblade:aimVector()
  return {mcontroller.facingDirection(), 0}
end

function Moonlightblade:damageAmount()
