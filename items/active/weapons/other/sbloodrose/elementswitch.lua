...
function AdaptableAmmo:adaptAbility()
  ...
  self.eType = self.ammoIndex == 1 and "physical" or (self.ammoIndex == 2 and "fire" or (self.ammoIndex == 3 and "electric" or "ice"))
  animator.setAnimationState("elementalType", self.ammoIndex)
  self.weapon.elementalType = self.elementalTypes[self.ammoIndex].elementalType
end
