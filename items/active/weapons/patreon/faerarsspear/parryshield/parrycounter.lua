...
function Parry:counter()
  ...
  animator.setAnimationState("swoosh", "fireCounter")
...
function Parry:followUp()
  local stance = self.stances["followUp"]
  self.weapon:updateAim()
  self.weapon:setStance(stance)
  animator.setParticleEmitterActive("electricswoosh", true)
  ...
  self.cooldownTimer = self.cooldownTime
  activeItem.setItemShieldPolys({})
  animator.setParticleEmitterActive("electricswoosh", false)
  animator.setParticleEmitterActive(self.weapon.elementalType.."Counter", false)
end
