...
function questInteract(entityId)
  ...
  elseif world.entityUniqueId(entityId) == self.turnInEntity or (type(world.entityUniqueId(entityId)) == "string" and string.find(world.entityUniqueId(entityId), self.turnInEntity)) or (world.entityName(entityId) and string.find(world.entityName(entityId), self.turnInEntity)) then
    quest.complete()
  end
end
