...
function teleport()
  ...
  if damage > 0 then
    ...
    world.spawnProjectile("ivrpg_assassinateswoosh", {mcontroller.xPosition() + mcontroller.facingDirection()*5, mcontroller.yPosition()}, self.id, {0,0}, false, damageConfig)
  end
end
